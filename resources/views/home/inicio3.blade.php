      ...
      <div class="p-4 border-t border-b">
        <div class="grid grid-cols-2">
            <div class="col-span-2 text-center">
              <button href="{{ 'https://ad.admitad.com/g/05dgete24s372c5c98e4b3e3b7aadc/?subid=udemy_courses_norml&ulp=https%3A%2F%2Fwww.udemy.com'.$item->url }}" rel="nofollow" target="_blank" class="bg-blue850 text-sm hover:bg-blue750 text-white font-bold py-2 px-6 rounded-full inline-flex items-center">
