@include('sliders.sliderCategory1')
<div class="w-full mt-8 mb-6 mx-auto px-4 flex items-center justify-between">
  <span class="text-2xl">
    Los mejores cursos de
    <strong class="text-2xl">{{ __($categoria[0]['categoria']) }}</strong>
  </span>
  <div class="flex items-center select-none invisible sm:invisible md:visible lg:visible xl:visible">
      <a href="" class="ml-2 flex items-center border py-2 px-3 leading-none text-white bg-blue850 hover:bg-blue750 rounded-md p-2 focus:outline-none">
