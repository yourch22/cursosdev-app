...
@section('content')
    <div class="mb-4 md:mb-0 w-full max-w-screen-md mx-auto relative">
        <h2 class="my-6 text-lg lg:text-xl font-bold"><strong>Política de Cookies</strong></h2>
         <p> En esta web se utilizan cookies de terceros y propias para conseguir que tengas una mejor experiencia de navegación, puedas compartir contenido en redes sociales y para que podamos obtener estadísticas de los usuarios.<br><br>
            ...
            <h3 class="text-lg lg:text-xl my-4 font-bold">Entidad Responsable</h3>
            <p class="ng-binding">La entidad responsable de la recogida, procesamiento y utilización de tus datos personales, en el sentido establecido por la Ley de Protección de Datos Personales es la página  <a class="font-semibold underline text-blue-800" href="/" >https://cursosdev.com </a>, propiedad de cursosdev – lima.</p>
                        ...
                        <p>Las cookies utilizadas en nuestro sitio web, son de sesión y de terceros, y nos permiten almacenar y acceder a información relativa al idioma, el tipo de navegador utilizado, y otras características generales predefinidas por el usuario, así como, seguir y analizar la actividad que lleva a cabo, con el objeto de introducir mejoras y prestar nuestros servicios de una manera más eficiente y personalizada. <br><br>
                          ...
                          cursosdev) o bien cuando se borran manualmente. </p>  
            <p></p>
            ...
            <h3 class="text-lg lg:text-xl my-4 font-bold">Cookies de rendimiento</h3>
            ...
            <h3 class="text-lg lg:text-xl my-4 font-bold">Cookies de geo-localización</h3>
            ...
            <h3 class="text-lg lg:text-xl my-4 font-bold">Cookies de registro</h3>
            ...
            <h3 class="text-lg lg:text-xl my-4 font-bold">Cookies de analíticas</h3>
            ...
            <p class="ng-binding">Importante: Salvo que el usuario decida registrarse en un servicio de
              cursosdev, la cookie nunca irá asociada a ningún dato de carácter personal que pueda identificarle. Dichas cookies sólo serán utilizadas con propósitos estadísticos que ayuden a la optimización de la experiencia de los usuarios en el sitio.</p>

            <h3 class="text-lg lg:text-xl my-4 font-bold">Cookies de publicidad</h3>
            ...
            <p>
              <a class="font-semibold underline text-blue-800" href="http://www.google.es/policies/privacy/ads/#toc-doubleclick">http://www.google.es/policies/privacy/ads/#toc-doubleclick</a>
              y a
              <a class="font-semibold underline text-blue-800" href="http://www.google.es/policies/privacy/ads/">http://www.google.es/policies/privacy/ads/</a>.</p>
            <h3 class="text-lg lg:text-xl my-4 font-bold">¿Cómo puedo deshabilitar las cookies en mi navegador?</h3>
            ...
            <p>Para más información sobre la administración de las cookies en Google Chrome:
              <a class="font-semibold underline text-blue-800" href="https://support.google.com/chrome/answer/95647?hl=es">https://support.google.com/chrome/answer/95647?hl=es</a>
            </p>
            <p>Para más información sobre la administración de las cookies en Internet Explorer:
              <a class="font-semibold underline text-blue-800" href="http://windows.microsoft.com/es-es/windows-vista/cookies-frequently-asked-question"></a>
              <a class="font-semibold underline text-blue-800" href="http://windows.microsoft.com/es-es/windows-vista/cookies-frequently-asked-questions">http://windows.microsoft.com/es-es/windows-vista/cookies-frequently-asked-questions</a>
            </p>
            <p>
              <a class="font-semibold underline text-blue-800" href="http://windows.microsoft.com/es-es/windows-vista/cookies-frequently-asked-question"></a>Para más información sobre la administración de las cookies en Mozilla Firefox:
              <a class="font-semibold underline text-blue-800" href="http://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-que-los-sitios-we%20">http://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-que-los-sitios-we
              </a>
            </p>
            <p>Para más información sobre la administración de las cookies en Safari:
              <a class="font-semibold underline text-blue-800" href="http://www.apple.com/es/privacy/use-of-cookies/%20">http://www.apple.com/es/privacy/use-of-cookies/
              </a>
            </p>
            <p>Para más información sobre la administración de las cookies en Opera:
              <a class="font-semibold underline text-blue-800" href="http://help.opera.com/Windows/11.50/es-ES/cookies.html">http://help.opera.com/Windows/11.50/es-ES/cookies.html</a>
            </p>
            <p>Si desea dejar de ser seguido por Google Analytics visite:
              <a class="font-semibold underline text-blue-800" href="http://tools.google.com/dlpage/gaoptout">http://tools.google.com/dlpage/gaoptout</a>
            </p>
            <h3 class="text-lg lg:text-xl my-4 font-bold">Para saber más sobre las cookies</h3>
            <p>Puede obtener más información sobre la publicidad online basada en el comportamiento y la privacidad online en el siguiente enlace:
              <a class="font-semibold underline text-blue-800" href="http://www.youronlinechoices.com/es/">http://www.youronlinechoices.com/es/</a>
            </p>
            <p>Protección de datos de Google Analytics:
              <a class="font-semibold underline text-blue-800" href="http://www.google.com/analytics/learn/privacy.html">http://www.google.com/analytics/learn/privacy.html</a>
            </p>
            <p>Cómo usa Google Analytics las cookies:
              <a class="font-semibold underline text-blue-800" href="https://developers.google.com/analytics/devguides/collection/analyticsjs/cookie-usage?hl=es#analyticsjs">https://developers.google.com/analytics/devguides/collection/analyticsjs/cookie-usage?hl=es#analyticsjs</a>
            </p>
            <h3 class="text-lg lg:text-xl my-4 font-bold">Actualizaciones y cambios en la política de privacidad/cookies</h3>
