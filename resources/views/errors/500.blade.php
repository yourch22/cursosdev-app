    ...
    <div class="flex items-center">
        <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
            <div class="max-w-md">
                ...
                <h3>Error del servidor: 500 (error interno del servidor)</h3>
                <hr>
                <h3>¿Qué significa esto?</h3>
                <p class="text-2xl md:text-3xl font-light leading-normal">
                    Algo salió mal en nuestros servidores mientras estábamos procesando su solicitud.
                    Lo sentimos mucho y trabajaremos duro para resolverlo como
                    tan pronto como sea posible.
                </p>
                <a href="{{url('/coupons')}}" class="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-blue-600 active:bg-blue-600 hover:bg-blue-700">
                Tal vez le gustaría ir a nuestra página de inicio
                </a>
            </div>
            <div class="max-w-lg">
